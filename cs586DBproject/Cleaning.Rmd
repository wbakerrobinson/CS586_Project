...
### Includes creation of the grade table and grade_rel table
...
## Updating the tables based on the most recent .csv file, taking into account redundant submissions, constraint checking, etc.
