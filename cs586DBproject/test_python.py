...
if (connected == True and r.availSurvBool == True and ddl_run == False):
  ...
  cur.copy_from(to_file_obj(r.avail_df), availability, sep = ',', null = 'NaN')
  cur.copy_from(to_file_obj(r.avail_rel_df), availability_rel, sep = ',', null = 'NaN')
  cur.copy_from(to_file_obj(r.avail_comm_df), availability_comments, sep = ',', null = 'NaN')
