...
if(py$qerror == FALSE)
{
  p <- ggplot(data = py$data, aes(x = project_name, y = interest, fill = confidence)) + 
          geom_tile() +
          scale_fill_gradient(low = "white", high = "blue") +
          labs(title = "Heatmap of Confidence by interest and project", x = "Project", y = "Interest Level") +
          theme_bw() +
